...
#if defined(_WIN32)
// Win32 needs to be included before mmsystem.h
...
#include "sm/base/criticalsection.h"
#include "sm/base/rw_lock_wrapper.h"
#include "sm/base/tick_util.h"
...
// prevent clock drift.
class Win32RealTimeClock : public RealTimeClock {
 public:
  Win32RealTimeClock()
      : last_time_ms_(0),
        num_timer_wraps_(0),
...
#if defined(_WIN32)
static Win32RealTimeClock* volatile g_shared_clock = nullptr;
#endif
Clock* Clock::GetRealTimeClock() {
  ...
  Win32RealTimeClock* clock = new Win32RealTimeClock;
