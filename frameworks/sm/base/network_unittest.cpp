...
#if defined(SM_WIN)
#include "sm/base/logging.h"  // For LOG_GLE
#endif
...
class NetworkTest : public testing::Test, public sigslot::has_slots<>  {
 public:
  ...
  static void CallConvertIfAddrs(const BasicNetworkManager& network_manager,
    ...
    scoped_ptr<IfAddrsConverter> ifaddrs_converter(new IfAddrsConverter());
...
TEST_F(NetworkTest, DISABLED_TestCreateNetworks) {
  ...
  for (it = result.begin();
    ...
    // TODO(thaloun): Use AsyncSocket once it supports IPv6.
