...
#ifndef SM_BASE_ASYNC_PACKET_SOCKET_H_
#define SM_BASE_ASYNC_PACKET_SOCKET_H_

#include "sm/base/dscp.h"
...
class AsyncPacketSocket : public sigslot::has_slots<> {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncPacketSocket);
};

}  // namespace sm

#endif  // SM_BASE_ASYNC_PACKET_SOCKET_H_
