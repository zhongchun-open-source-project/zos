...
#if !__has_feature(objc_arc) && (defined(SM_MAC))
#include "sm/base/mac_cocoa_thread_helper.h"
...
ThreadManager* ThreadManager::Instance() {
  SM_DEFINE_STATIC_LOCAL(ThreadManager, thread_manager, ());
...
void Thread::InvokeBegin() {
  TRACE_EVENT_BEGIN0("sm", "Thread::Invoke");
}

void Thread::InvokeEnd() {
  TRACE_EVENT_END0("sm", "Thread::Invoke");
}
