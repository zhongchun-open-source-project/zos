...
#ifndef SM_BASE_NAT_SOCKET_FACTORY_H_
#define SM_BASE_NAT_SOCKET_FACTORY_H_
...
class NATSocketFactory : public SocketFactory, public NATInternalSocketFactory {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(NATSocketFactory);
};
...
class NATSocketServer : public SocketServer, public NATInternalSocketFactory {
 ...
 private:
  ...
  TranslatorMap nats_;
  SM_DISALLOW_COPY_AND_ASSIGN(NATSocketServer);
};
...
#endif  // SM_BASE_NAT_SOCKET_FACTORY_H_
