...
//										  (as under Win32) with the SIGSLOT_PURE_ISO switch. If you're using
...
//										  single global mutex (actually a critical section on Win32 because they
...
#ifndef SM_BASE_SIGSLOT_H__
#define SM_BASE_SIGSLOT_H__
...
#if defined(SIGSLOT_PURE_ISO) || (!defined(SM_WIN) && !defined(__GNUG__) && !defined(SIGSLOT_USE_POSIX_THREADS))
...
// TODO: change this namespace to sm?
namespace sigslot {
