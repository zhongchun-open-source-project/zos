...
/** Java wrapper for SM logging. */
public class Logging {
  private static final Logger fallbackLogger = Logger.getLogger("com.zhongchun.sm.Logging");
  private static volatile boolean tracingEnabled;
  private static volatile boolean nativeLibLoaded;

  static {
    try {
      System.loadLibrary("zhongchun_sm_so");
      nativeLibLoaded = true;
    } catch (UnsatisfiedLinkError t) {
      // If native logging is unavailable, log to system log.
      fallbackLogger.setLevel(Level.ALL);

      fallbackLogger.log(Level.WARNING, "Failed to load zhongchun_sm_so: ", t);
    }
  }

  // Keep in sync with sm/common_types.h:TraceLevel.
  ...
  // Keep in sync with sm/base/logging.h:LoggingSeverity.
