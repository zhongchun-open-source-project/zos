...
#ifndef SM_BASE_ROLLING_ACCUMULATOR_H_
#define SM_BASE_ROLLING_ACCUMULATOR_H_
...
class RollingAccumulator {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(RollingAccumulator);
};

}  // namespace sm

#endif  // SM_BASE_ROLLING_ACCUMULATOR_H_
