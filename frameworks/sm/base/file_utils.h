...
#ifndef SM_BASE_FILE_UTILS_H_
#define SM_BASE_FILE_UTILS_H_
...
class Filesystem {
 ...
 private:
  ...
  SM_DISALLOW_IMPLICIT_CONSTRUCTORS(Filesystem);
};
...
class FilesystemScope{
 ...
 private:
  ...
  SM_DISALLOW_IMPLICIT_CONSTRUCTORS(FilesystemScope);
};
