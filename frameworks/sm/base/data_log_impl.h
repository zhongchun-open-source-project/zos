...
#ifndef SM_BASE_DATA_LOG_IMPL_H_
#define SM_BASE_DATA_LOG_IMPL_H_
...
class DataLogImpl {
 ...
 private:
  ...
  typedef scoped_ptr<CriticalSectionWrapper> CritSectScopedPtr;
  ...
  // impl.
  scoped_ptr<PlatformThread> file_writer_thread_;
  RWLockWrapper*            tables_lock_;
};

}  // namespace sm

#endif  // SM_BASE_DATA_LOG_IMPL_H_
