...
// This is a highly stripped-down version of libsm's talk/base/logging.h.
// It is a thin wrapper around SM_TRACE, maintaining the libsm log
...
#ifndef SM_BASE_LOGGING_WRAPPER_H_
#define SM_BASE_LOGGING_WRAPPER_H_
...
//////////////////////////////////////////////////////////////////////
// Macros which automatically disable logging when SM_LOGGING == 0
//////////////////////////////////////////////////////////////////////
...
#if defined(SM_RESTRICT_LOGGING)
...
#define LOG_SEVERITY_PRECONDITION(sev) \
  RESTRICT_LOGGING_PRECONDITION(sev) !(LogMessage::Loggable(sev)) \
    ? (void) 0 \
    : LogMessageVoidify() &
...
#endif  // SM_BASE_LOGGING_WRAPPER_H_
