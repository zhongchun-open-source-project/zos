...
#ifndef SM_BASE_PROXY_SERVER_H_
#define SM_BASE_PROXY_SERVER_H_
...
class ProxyBinding : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(ProxyBinding);
};
...
class ProxyServer : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(ProxyServer);
};
...
class SocksProxyServer : public ProxyServer {
 ...
 protected:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SocksProxyServer);
};

}  // namespace sm

#endif  // SM_BASE_PROXY_SERVER_H_
