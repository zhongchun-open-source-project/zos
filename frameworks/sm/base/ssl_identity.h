...
#ifndef SM_BASE_SSL_IDENTITY_H_
#define SM_BASE_SSL_IDENTITY_H_
...
class SSLCertChain {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SSLCertChain);
};
...
// TODO(hbos): Remove once KeyType (to be modified) and
// blink::WebSM_KeyType (to be landed) match. By using this function in Chromium
