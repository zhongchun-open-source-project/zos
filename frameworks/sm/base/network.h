...
#ifndef SM_BASE_NETWORK_H_
#define SM_BASE_NETWORK_H_
...
class NetworkManagerBase : public NetworkManager {
 ...
 private:
  ...
  scoped_ptr<Network> ipv4_any_address_network_;
  scoped_ptr<Network> ipv6_any_address_network_;
...
class Network {
 public:
  ...
  // Here is the rule on how we mark the IPv6 address as ignorable for SM.
  ...
  // internet but might be useful for a close SM deployment.
  ...
  // that is SM will have one extra Network to generate candidates
