...
#if defined(SM_WIN)  // Win32 specific implementation for reading Internet
...
#if defined(SM_MAC) && !defined(SM_IOS)  // SM_MAC && !defined(SM_IOS) specific implementation for reading system wide
            // proxy settings.
