...
#ifndef SM_BASE_STREAM_H_
#define SM_BASE_STREAM_H_
...
class StreamInterface : public MessageHandler {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(StreamInterface);
};
...
class StreamAdapterInterface : public StreamInterface,
 ...
 private:
  ...
  bool owned_;
  SM_DISALLOW_COPY_AND_ASSIGN(StreamAdapterInterface);
};
...
class StreamTap : public StreamAdapterInterface {
 ...
 private:
  ...
  int tap_error_;
  SM_DISALLOW_COPY_AND_ASSIGN(StreamTap);
};
...
class FileStream : public StreamInterface {
...
#if defined(SM_POSIX) && !defined(__native_client__)
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(FileStream);
};
...
class MemoryStreamBase : public StreamInterface {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(MemoryStreamBase);
};
...
class FifoBuffer : public StreamInterface {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(FifoBuffer);
};
...
class LoggingAdapter : public StreamAdapterInterface {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(LoggingAdapter);
};
 ...
 private:
  class StreamRefCount {
   ...
   private:
    ...
    int ref_count_;
    CriticalSection cs_;
    SM_DISALLOW_COPY_AND_ASSIGN(StreamRefCount);
  };
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(StreamReference);
};
