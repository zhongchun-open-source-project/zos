...
PhysicalSocket::PhysicalSocket(PhysicalSocketServer* ss, SOCKET s)
  ...
  // initialized by constructor of a static object. If neccessary libsm
  ...
  switch (opt) {
    case OPT_DONTFRAGMENT:
      ...
      *sopt = IP_DONTFRAGMENT;
      break;
#elif defined(SM_MAC) || defined(BSD) || defined(__native_client__)
...
class PosixSignalHandler {
 public:
  ...
  static PosixSignalHandler* Instance() {
    SM_DEFINE_STATIC_LOCAL(PosixSignalHandler, instance, ());
    return &instance;
  }
