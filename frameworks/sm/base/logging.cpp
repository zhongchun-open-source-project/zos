...
#endif  // SM_MAC && !defined(SM_IOS) || SM_ANDROID

static const char kLibsm[] = "libsm";
...
void LogMessage::OutputToDebug(const std::string& str,
...
#if defined(SM_MAC) && !defined(SM_IOS) && defined(NDEBUG)
  ...
  // need to map libsm's severity levels to Android ones first.
