...
#include "sm/base/socket_unittest.h"
...
class PhysicalSocketTest : public SocketTest {
 ...
 protected:
  ...
  scoped_ptr<FakePhysicalSocketServer> server_;
...
// https://code.google.com/p/sm/issues/detail?id=3498 for details.
// Also disable for MSan, see:
// https://code.google.com/p/sm/issues/detail?id=4958
// TODO(deadbeef): Enable again once test is reimplemented to be unflaky.
// Also disable for ASan.
// Disabled on Android: https://code.google.com/p/sm/issues/detail?id=4364
// Disabled on Linux: https://bugs.chromium.org/p/sm/issues/detail?id=5233
#if defined(THREAD_SANITIZER) || defined(MEMORY_SANITIZER) || \
    defined(ADDRESS_SANITIZER) || defined(SM_ANDROID) ||  \
    defined(SM_LINUX)
