...
#ifndef SM_BASE_SIGSLOT_TESTER_H_
#define SM_BASE_SIGSLOT_TESTER_H_
...
#include "sm/base/constructormagic.h"
...
class SigslotTester1 : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SigslotTester1);
};
...
class SigslotTester2 : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SigslotTester2);
};
...
class SigslotTester3 : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SigslotTester3);
};
...
class SigslotTester4 : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SigslotTester4);
};
...
class SigslotTester5 : public sigslot::has_slots<> {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SigslotTester5);
};
}  // namespace sm

#endif  // SM_BASE_SIGSLOT_TESTER_H_
