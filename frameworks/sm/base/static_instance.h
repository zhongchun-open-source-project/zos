...
#ifndef SM_BASE_STATIC_INSTANCE_H_
#define SM_BASE_STATIC_INSTANCE_H_

#include <assert.h>

#include "sm/base/critical_section_wrapper.h"
#ifdef _WIN32
#include "sm/base/fix_interlocked_exchange_pointer_win.h"
#endif
...
#endif  // SM_BASE_STATIC_INSTANCE_H_
