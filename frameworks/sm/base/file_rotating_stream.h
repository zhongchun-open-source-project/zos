...
#ifndef SM_BASE_FILE_ROTATING_STREAM_H_
#define SM_BASE_FILE_ROTATING_STREAM_H_
...
class FileRotatingStream : public StreamInterface {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(FileRotatingStream);
};
...
// this is because we anticipate that in SM the beginning and end of the
...
class CallSessionFileRotatingStream : public FileRotatingStream {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(CallSessionFileRotatingStream);
};

}  // namespace sm

#endif  // SM_BASE_FILE_ROTATING_STREAM_H_
