...
#ifndef SM_BASE_ASYNC_INVOKER_H_
#define SM_BASE_ASYNC_INVOKER_H_

#include "sm/base/async_invoker_inl.h"
...
class AsyncInvoker : public MessageHandler {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncInvoker);
};
...
#endif  // SM_BASE_ASYNC_INVOKER_H_
