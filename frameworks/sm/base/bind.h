...
//   int main() {
//     Foo foo;
//     cout << Bind(&Foo::Test1, &foo)() << endl;
//     cout << Bind(&Foo::Test2, &foo)() << endl;
//     cout << Bind(&Foo::Test3, &foo, 3)() << endl;
//     cout << Bind(&Foo::Test4, &foo, 7, 8.5f)() << endl;
//   }
//
...
//       invoker.AsyncInvoke(Bind(&Bar::Test, this));
//     }
//   };
//
//   int main() {
//     scoped_refptr<Bar> bar = new RefCountedObject<Bar>();
//     auto functor = Bind(&Bar::Test, bar);
//     bar = nullptr;
...
#ifndef SM_BASE_BIND_H_
#define SM_BASE_BIND_H_
...
// scoped_refptr<T>, i.e. types that implements nullary functions AddRef()
