...
// Class Config is designed to ease passing a set of options across sm code.
...
class Config {
 public:
  ...
  Config() {}
  ~Config() {
    // Note: this method is inline so sm public API depends only
    // on the headers.
 ...
 private:
  ...
  static const T& default_value() {
    SM_DEFINE_STATIC_LOCAL(const T, def, ());
    return def;
  }
