...
The def file can be used to export symbols from the sm dll to enable
sm.load_library().
...
we use for this are specific to sm.
...
INCLUDEPRE_RE = re.compile(r"google::protobuf::internal::ExplicitlyConstructed|"
                           r"internal::LogMessage|"
                           r"internal::LogString|"
                           r"internal::CheckOpMessageBuilder|"
                           r"internal::PickUnusedPortOrDie|"
                           r"internal::ValidateDevice|"
                           r"ops::internal::Enter|"
                           r"strings::internal::AppendPieces|"
                           r"strings::internal::CatPieces|"
                           r"errors::Internal|"
                           r"Tensor::CopyFromInternal|"
                           r"kernel_factory::"
                           r"OpKernelRegistrar::InitInternal|"
                           r"io::internal::JoinPathImpl")
...
def main():
  ...
  with open(args.output, "w") as def_fp:
    ...
    if args.bitness == "64":
      def_fp.write("\t??1OpDef@sm@@UEAA@XZ\n")
    else:
      def_fp.write("\t??1OpDef@sm@@UAE@XZ\n")
