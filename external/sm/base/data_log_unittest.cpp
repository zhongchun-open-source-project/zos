...
TEST(TestDataLogCWrapper, VerifyCWrapper) {
  ...
  EXPECT_EQ(0, SmDataLogCHelper_TestCreateLog());
  EXPECT_EQ(0, SmDataLogCHelper_TestCombine());
  EXPECT_EQ(0, SmDataLogCHelper_TestAddTable());
  EXPECT_EQ(0, SmDataLogCHelper_TestAddColumn());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_int());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_int());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_float());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_float());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_double());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_double());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_int32());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_int32());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_uint32());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_uint32());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertCell_int64());
  EXPECT_EQ(0, SmDataLogCHelper_TestInsertArray_int64());
  EXPECT_EQ(0, SmDataLogCHelper_TestNextRow());
  EXPECT_EQ(0, SmDataLogCHelper_TestReturnLog());
}
