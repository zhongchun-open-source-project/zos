...
#ifndef SM_BASE_SCOPED_PTR_H_
#define SM_BASE_SCOPED_PTR_H_
...
#include "sm/base/deprecation.h"
#include "sm/base/template_util.h"
...
class scoped_ptr_impl {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(scoped_ptr_impl);
};
...
class scoped_ptr {
  ...
  // enabled.
  //static_assert(internal::IsNotRefCounted<T>::value,
 ...
 public:
  ...
  scoped_ptr(scoped_ptr<U, V>&& other)
      : impl_(&other.impl_) {
    static_assert(!is_array<U>::value, "U cannot be an array");
  }
...
template <typename T>
scoped_ptr<T> rtc_make_scoped_ptr(T* ptr) {
  return scoped_ptr<T>(ptr);
}

#endif  // #ifndef SM_BASE_SCOPED_PTR_H_
