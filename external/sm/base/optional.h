...
#ifndef SM_BASE_OPTIONAL_H_
#define SM_BASE_OPTIONAL_H_
...
// contain a value; use e.g. scoped_ptr<T> instead if that's too
// expensive.
//
...
//   it a null pointer; the function should probably use SM_[D]CHECK instead,
