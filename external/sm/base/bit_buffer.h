...
#ifndef SM_BASE_BIT_BUFFER_H_
#define SM_BASE_BIT_BUFFER_H_
...
class BitBuffer {
 ...
 protected:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(BitBuffer);
};
...
class BitBufferWriter : public BitBuffer {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(BitBufferWriter);
};

}  // namespace sm

#endif  // SM_BASE_BIT_BUFFER_H_
