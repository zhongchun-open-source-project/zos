...
#include "sm/base/nat_server.h"
#include "sm/base/nat_socket_factory.h"
...
class NatTcpTest : public testing::Test, public sigslot::has_slots<> {
 public:
  ...
  scoped_ptr<TestVirtualSocketServer> int_vss_;
  scoped_ptr<TestVirtualSocketServer> ext_vss_;
  scoped_ptr<Thread> int_thread_;
  scoped_ptr<Thread> ext_thread_;
  scoped_ptr<NATServer> nat_;
  scoped_ptr<NATSocketFactory> natsf_;
  scoped_ptr<AsyncSocket> client_;
  scoped_ptr<AsyncSocket> server_;
  scoped_ptr<AsyncSocket> accepted_;
};
...
TEST_F(NatTcpTest, DISABLED_TestConnectOut) {
  ...
  scoped_ptr<TestClient> in(CreateTCPTestClient(client_.release()));
  scoped_ptr<TestClient> out(
