...
#ifndef SM_BASE_SOCKET_ADAPTERS_H_
#define SM_BASE_SOCKET_ADAPTERS_H_
...
class BufferedReadAdapter : public AsyncSocketAdapter {
 ...
 private:
  ...
  bool buffering_;
  SM_DISALLOW_COPY_AND_ASSIGN(BufferedReadAdapter);
};
...
class AsyncSSLSocket : public BufferedReadAdapter {
 ...
 protected:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncSSLSocket);
};
...
class AsyncSSLServerSocket : public BufferedReadAdapter {
 ...
 protected:
  void ProcessInput(char* data, size_t* len) override;
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncSSLServerSocket);
};
...
class AsyncHttpsProxySocket : public BufferedReadAdapter {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncHttpsProxySocket);
};
...
class AsyncHttpsProxyServerSocket : public AsyncProxyServerSocket {
 ...
 private:
  ...
  void Error(int error);
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncHttpsProxyServerSocket);
};
*/
...
class AsyncSocksProxySocket : public BufferedReadAdapter {
 ...
 private:
  ...
  std::string user_;
  CryptString pass_;
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncSocksProxySocket);
};
...
class AsyncSocksProxyServerSocket : public AsyncProxyServerSocket {
 ...
 private:
  ...
  State state_;
  SM_DISALLOW_COPY_AND_ASSIGN(AsyncSocksProxyServerSocket);
};
...
class LoggingSocketAdapter : public AsyncSocketAdapter {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(LoggingSocketAdapter);
};
...
#endif  // SM_BASE_SOCKET_ADAPTERS_H_
