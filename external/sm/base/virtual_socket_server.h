...
#ifndef SM_BASE_VIRTUAL_SOCKET_SERVER_H_
#define SM_BASE_VIRTUAL_SOCKET_SERVER_H_
...
class VirtualSocketServer : public SocketServer, public sigslot::has_slots<> {
 ...
 private:
  ...
  double drop_prob_;
  SM_DISALLOW_COPY_AND_ASSIGN(VirtualSocketServer);
};
...
class VirtualSocket : public AsyncSocket, public MessageHandler {
 public:
  ...
  // instead of the original one TurnPort was bound against. Please see SM
...
#endif  // SM_BASE_VIRTUAL_SOCKET_SERVER_H_
