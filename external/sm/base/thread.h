...
#ifndef SM_BASE_THREAD_H_
#define SM_BASE_THREAD_H_
...
class ThreadManager {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(ThreadManager);
};
...
class Runnable {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(Runnable);
};
...
class Thread : public MessageQueue {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(Thread);
};
...
class AutoThread : public Thread {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(AutoThread);
};
...
class ComThread : public Thread {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(ComThread);
};
#endif
...
class SocketServerScope {
 ...
 private:
  ...
  SM_DISALLOW_IMPLICIT_CONSTRUCTORS(SocketServerScope);
};

}  // namespace sm

#endif  // SM_BASE_THREAD_H_
