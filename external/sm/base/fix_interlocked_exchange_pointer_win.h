...
#ifndef SM_BASE_FIX_INTERLOCKED_EXCHANGE_POINTER_WINDOWS_H_
#define SM_BASE_FIX_INTERLOCKED_EXCHANGE_POINTER_WINDOWS_H_
...
#endif // SM_BASE_FIX_INTERLOCKED_EXCHANGE_POINTER_WINDOWS_H_
