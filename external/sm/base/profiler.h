...
#ifndef SM_BASE_PROFILER_H_
#define SM_BASE_PROFILER_H_
...
#define PROFILE(msg) ProfilerScope UNIQUE_VAR(msg)
...
#define PROFILE_DUMP_ALL(sev) \
  Profiler::Instance()->ReportAllToLog(__FILE__, __LINE__, sev)
...
#define PROFILE_DUMP(sev, prefix) \
  Profiler::Instance()->ReportToLog(__FILE__, __LINE__, sev, prefix)
...
#define PROFILE_START(msg) Profiler::Instance()->StartEvent(msg)
#define PROFILE_STOP(msg) Profiler::Instance()->StopEvent(msg)
...
class Profiler {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(Profiler);
};
...
class ProfilerScope {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(ProfilerScope);
};
