...
#ifndef SM_BASE_SIGNALTHREAD_H_
#define SM_BASE_SIGNALTHREAD_H_
 ...
 private:
  ...
  class Worker : public Thread {
   ...
   private:
    ...
    SM_DISALLOW_IMPLICIT_CONSTRUCTORS(Worker);
  };
  ...
  class SCOPED_LOCKABLE EnterExit {
   ...
   private:
    ...
    SM_DISALLOW_IMPLICIT_CONSTRUCTORS(EnterExit);
  };
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SignalThread);
};
