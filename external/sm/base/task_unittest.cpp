...
class AbortTask : public Task {
 ...
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(AbortTask);
};
...
class TaskAbortTest : public sigslot::has_slots<> {
 ...
 private:
  ...
  MyTaskRunner task_runner_;
  SM_DISALLOW_COPY_AND_ASSIGN(TaskAbortTest);
};
...
class SetBoolOnDeleteTask : public Task {
 ...
 private:
  ...
  SM_DISALLOW_COPY_AND_ASSIGN(SetBoolOnDeleteTask);
};
...
class AbortShouldWakeTest : public sigslot::has_slots<> {
 ...
 private:
  ...
  MyTaskRunner task_runner_;
  SM_DISALLOW_COPY_AND_ASSIGN(AbortShouldWakeTest);
};
...
class TimeoutChangeTest : public sigslot::has_slots<> {
 ...
 private:
  ...
  int task_count_;
  SM_DISALLOW_COPY_AND_ASSIGN(TimeoutChangeTest);
};
...
class DeleteTestTaskRunner : public TaskRunner {
 public:
  ...
  virtual int64_t CurrentTime() { return GetCurrentTime(); }
 private:
  SM_DISALLOW_COPY_AND_ASSIGN(DeleteTestTaskRunner);
};
